...
public:
    ...
    static void applyTransform_p(Object3D* o);


    static void applyTransformProjection(Object3D *o);
    static void applyTransformProjection(Movable *movable);
    static void applyTransform(Movable *movable);
    static void loadIdentityMatrix();
    static void computeMVP();
